...
const questions = inquirer
    .prompt([
        ...
        {
            type: 'confirm',
            message: 'Create an `assets/images` folder in your repository and upload your screenshot to it. Did you finish these steps?',
            name: 'file',

        },
        {
            type: 'input',
            message: 'Copy and paste your screenshot file here: .. If no screenshot, Press `return`.',
            name: 'screenshot',
